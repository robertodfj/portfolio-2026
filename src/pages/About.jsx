...
function About() {
    return (
        <div className="h-screen w-full px-4 md:px-0 py-20">
            ...
            <div className="mt-9 h-screen w-full">
                ...
                <div className="w-full flex flex-col lg:flex-row justify-center items-start lg:items-center gap-8 px-4 md:px-8">
  {/* Tarjeta */}
