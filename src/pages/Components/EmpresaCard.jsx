export default function EmpresaCard({ nombre, titulo, icono }) {
  return (
    <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-rotate-1 w-[350px]">
      <div className="text-white rounded-3xl border border-green-500/20 bg-linear-to-tr from-[#0F0F0F] to-[#0B0B0B] shadow-2xl duration-700 z-10 relative backdrop-blur-xl hover:border-green-500/40 overflow-hidden hover:shadow-green-500/10 hover:shadow-3xl">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute -bottom-20 -left-20 w-48 h-48 rounded-full bg-linear-to-tr from-green-500/10 to-transparent blur-3xl opacity-30 group-hover:opacity-50 transform group-hover:scale-110 transition-all duration-700"></div>
        ...
        <div className="p-8 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mb-4 transform group-hover:scale-105 transition-transform duration-300">
              <p className="text-3xl font-bold bg-linear-to-r from-green-400 via-green-500 to-green-400 bg-clip-text text-transparent">
                {titulo}
              </p>
            </div>

            {/* Nombre / fecha */}
            <p className="text-gray-300 text-sm leading-relaxed transform group-hover:text-gray-200 transition-colors duration-300 font-semibold">
              {nombre}
            </p>

            {/* Línea animada */}
            <div className="mt-6 w-1/3 h-0.5 bg-linear-to-r from-transparent via-green-500 to-transparent rounded-full transform group-hover:w-1/2 group-hover:h-1 transition-all duration-500 animate-pulse"></div>
